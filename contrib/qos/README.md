...
This means one can have an always-on petrolheadd instance running, and another local petrolheadd/petrolhead-qt instance which connects to this node and receives blocks from it.
