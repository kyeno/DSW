...
#define MyAppName "Petrolhead Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://petrolhead.com"
#define MyAppExeName "petrolhead-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/PTLH/bootstrap.zip"
...
DefaultDirName={autopf}\Petrolhead
...
OutputDir=.\output
OutputBaseFilename=PetrolheadSetup
...
DefaultGroupName=Petrolhead Core
...
[Files]
Source: ".\package\petrolhead-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Petrolhead\Petrolhead-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Petrolhead\Petrolhead-Qt,strDataDir|{userappdata}\Petrolhead\}');
  Result := True;
end;
