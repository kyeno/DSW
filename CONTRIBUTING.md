Contributing to Petrolhead Core
============================

The Petrolhead Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Petrolhead Core project, and is not to be
confused with overall Petrolhead Network Protocol consensus changes.

Whether a pull request is merged into Petrolhead Core rests with the project merge
...
Patches that change Petrolhead consensus rules are considerably more involved than
...
Where a patchset proposes to change the Petrolhead consensus, it must have been
...
The project leader is the release manager for each Petrolhead Core release.
