...
#define __PORT_MAINNET__ 42424
#define __PORT_TESTNET__ 24242
#define __PORT_REGTEST__ 41414
 ...
 * Petrolhead system. There are three: the main network on which people trade goods
