...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Petrolhead petrolhead-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  petrolhead-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded petrolhead transaction") + "\n" +
                               "  petrolhead-tx [options] -create [commands]   " + _("Create hex-encoded petrolhead transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded petrolhead transaction
