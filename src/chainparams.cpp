...
public:
    CMainParams()
    {
        ...
        // /////////////////////////////////////////////////////////////////
        /*
         uint32_t nGenesisTime = 1657054165; // Tue 05 Jul 2022 10:52:51 PM CEST
        ...
        */
        ...
        genesis = CreateGenesisBlock(1657054165, 756602, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000003c8bddb6c9502a36124fb669d36a5bbc864c0a9e910732d3c1b3122da50"));
        ...
        consensus.nStakeMinAge = 60 * 30; // 30min
        ...
        // spork keys
        consensus.strSporkPubKey = "04BCE71AAF63A742248C0ED8F64C7265F38B3507821F57825EAC988D7337A12FB2C0F9078AD5FB60B1B90E0CB221CFBBF6D1D7682149AFFC1CFD3255C248677F9C";
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight                  = 151;
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MODIFIER_V2].nActivationHeight      = 161;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_MASTERNODE_RANK_V2].nActivationHeight     = 501;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98); // b
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 98); // b
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet petrolhead addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet petrolhead script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet petrolhead BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet petrolhead BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet petrolhead BIP44 coin type is '1' (All coin's testnet default)
