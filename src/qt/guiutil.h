...
/** Utility functions used by the Petrolhead Qt UI.
 */
namespace GUIUtil
{
...
// Render PTLH addresses in monospace font
...
// Parse "petrolhead:" URI into recipient object, return true on successful parsing
