...
/* Petrolhead GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Petrolhead"
#define QAPP_ORG_DOMAIN "petrolhead.org"
#define QAPP_APP_NAME_DEFAULT "Petrolhead-Qt"
#define QAPP_APP_NAME_TESTNET "Petrolhead-Qt-testnet"
