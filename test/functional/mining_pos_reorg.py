...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected PTLH supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check PTLH supply at the beginning
        # ------------------------------------------
        # PTLH supply: block rewards minus burned fees for minting
        ...
        # Verify that PTLH supplies were properly updated after the spends and reorgs
        self.log.info("Check PTLH supply...")
