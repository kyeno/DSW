...
"""Verify that starting petrolhead with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start petrolhead with -? for help text")
        ...
        self.log.info("Start petrolhead with -version for version information")
